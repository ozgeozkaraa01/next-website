...
const About = () => {
  return (
    <>
      ...
      <TransitionEffect />
      <Header />
      <main className="flex w-full flex-col items-center justify-center bg-[#e0eeec]">
        <Layout className="pt-16">
          <AnimatedText text="Passion Fuels Purpose!" className="mb-16" />
          <div className="grid w-full grid-cols-8 gap-16">
            <div className="col-span-3 flex flex-col items-start justify-start">
              <h2 className="mb-4 text-2xl font-bold uppercase bg-gradient-to-r from-pink-500 via-purple-500 to-blue-500 text-transparent bg-clip-text">
                Biography
              </h2>
              ...
              <p className="my-4 font-medium text-gray-500 hover:text-gray-900 cursor-pointer">
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Error
                quas eum possimus omnis dolorem dolores placeat voluptatum,
                tenetur sed iusto praesentium maxime totam, eaque dicta id
                aspernatur magnam provident expedita.
            ...
            <div className="col-span-3 relative h-min rounded-2xl border-2 border-solid border-[#17244f] bg-white p-12">
              <div className="absolute top-0 -right-3 -z-10 w-[100%] h-[100%] rounded-[2rem] bg-[#17244f]" />
              <img
